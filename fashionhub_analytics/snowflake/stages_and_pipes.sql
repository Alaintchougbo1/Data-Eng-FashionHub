...
-- External stage (example S3; adjust credentials/integration)
create or replace stage STAGE_S3
  url='s3://your-bucket/fashionhub/'
...
-- Snowpipe for automatic ingestion from S3 into RAW_DATA.ORDERS (example CSV)
